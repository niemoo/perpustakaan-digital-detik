...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3 bg-teal-600">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="/beranda" class="flex items-center ms-2 md:me-24">
            <p class="text-xl text-white font-semibold sm:text-2xl whitespace-nowrap">
                {{ Auth::user()->username }}
            </p>
            <span class="mx-1 text-xl text-white font-semibold sm:text-2xl whitespace-nowrap">
                - Dashboard
            </span>
          </a>
        </div>
            ...
            <div class="flex items-center ms-3">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                ...
                <form action="{{ route('logout') }}" method="POST"  role="none">
                    @csrf
                    <button type="submit" class="block px-4 py-2 text-sm w-full text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Logout</button>
                </form>
                {{-- <ul class="py-1">
                  <li>
                    <a href="#">Sign out</a>
